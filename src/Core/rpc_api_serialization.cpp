...
void ser_members(cryonero::api::walletd::GetTransaction::Request &v, ISeria &s) { seria_kv("hash", v.hash, s); }
...
void ser_members(cryonero::api::cryonerod::SubmitBlock::Response &v, ISeria &s) { seria_kv("status", v.status, s); }
...
void ser_members(cryonero::api::cryonerod::BlockHeaderLegacy &v, ISeria &s) {
	ser_members(static_cast<cryonero::api::BlockHeader &>(v), s);
